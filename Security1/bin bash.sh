...
snort -c /ruta/a/snort.conf -q -l /ruta/de/salida -v -i eno1 -K -k none -N -l /home/alexsugimoto/Documentos/DAM/Sistemas_Informáticos/2EV/ASAlex_Actividad_Evaluable2EV/Security1 -b -B 512 &
